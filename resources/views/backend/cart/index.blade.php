...
<div class="h-scree p-5">
    <main class="flex flex-1 bg-white p-5 rounded-lg shadow-md">
        <section class="flex-1 p-5 bg-white">
            ...
            <div class="grid lg:grid-cols-3 gap-4 overflow-auto h-[500px] no-scrollbar">
                @foreach ($medicineModel as $item)
                    ...
                    {{-- <div class="">
                        <div class="border rounded-md p-4 text-center">
                            ...
                            <img src="{{ asset('/images/no-img.png') }}" alt="image">
                            @endif
                            <img src="{{  asset('storage/' . $item->Image) }}" alt="Costa Coffee"
                    ...
                    <div class="rounded-md shadow-md hover:shadow-lg">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Duis vitae ante
        ...
        <aside class="w-1/3 p-5 bg-white border-l shadow-lg rounded-lg border">
            ...
            <button class="w-full bg-green-500 rounded-lg text-white py-2 mt-4">Pay ($85.50)</button>
        </aside>
    </main>
</div>
        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                    <div class="space-y-6">
                        <div
                            class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 md:p-6">
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                <a href="#" class="shrink-0 md:order-1">
                                    <img class="h-20 w-20 dark:hidden"
                                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"
                                ...
                                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                    <a href="#"
                                        class="text-base font-medium text-gray-900 hover:underline dark:text-white">PC
                                        system
                                        All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB, SSD
                                        256GB,
                        ...
                        <div
                            class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700md:p-6">
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                <a href="#" class="shrink-0 md:order-1">
                                    <img class="h-20 w-20 dark:hidden"
                                        src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/apple-watch-light.svg"
