            ...
            <div x-data="{ dropdownOpen: false }" class="relative">
                ...
                <div x-show="dropdownOpen"
                    ...
                    <x-dropdown-link :href="route('profile.edit')">
                        <span
                        class="block px-3 py-2 text-sm text-gray-700 rounded-md hover:bg-indigo-600 hover:text-white">Profile</span>
                    </x-dropdown-link>
                      ...
                      <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')"
                            ...
                            <span
                        class="block px-3 py-2 text-sm text-gray-700 rounded-md hover:bg-indigo-600 hover:text-white">Logout</span>
                        </x-dropdown-link>
                    </form>
                </div> 
